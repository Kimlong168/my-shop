...
<body>
<div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased  text-white">
      ...
      <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
        ...
        <div class="flex justify-end items-center h-14 bg-gray-800  header-right w-full">
          <div >
            <!-- seacrh bar -->
          ...
          <ul class="flex items-center">
           ...
           @if(Auth::check())
              <li>
                <form class="flex items-center mr-4 hover:text-blue-100" method="POST" action="/logout">
                  @csrf
      ...
      <div class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-blue-900 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          <ul class="flex flex-col py-4 space-y-1">
            ...
            <li>
              <a href="/categories" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
      ...
      <div class="h-full ml-14 mt-14 mb-10 md:ml-64 p-10 pt-5">
            {{$slot}}
      </div>
    </div>
</body>
